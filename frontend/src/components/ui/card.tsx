...
>(({ className, inset = false, ...props }, ref) => (
    <div
        ...
        className={cn(
            ...
            inset
                ? "rounded-2xl shadow-neu-inset dark:shadow-neu-dark-inset p-5"
                : "rounded-[32px] shadow-neu-extruded dark:shadow-neu-dark-extruded",
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <h3
        ref={ref}
        className={cn(
            "text-xl sm:text-2xl font-bold font-display tracking-tight text-foreground",
            className
        )}
        {...props}
    />
